...
public class PatrollingObstacle : Obstacle
{
    ...
    public Transform transformRota;
    ...
    protected float k_LaneOffset = 0f;
    ...
    void Start()
    {
        ...
        k_LaneOffset = m_Segement.manager.laneOffset - 0.1f;
        ...
        if (animator != null)
        {
            ...
            animator.SetFloat(s_SpeedRatioHash, 1); // clip.length / actualTime
        }
    }
    ...
    void Update()
    {
        ...
        if (transform.localPosition.x <= -k_LaneOffset)
        {
            transformRota.localRotation = Quaternion.Euler(0f, 180f, 0f);
        }
        else if (transform.localPosition.x >= k_LaneOffset)
        {
            transformRota.localRotation = Quaternion.Euler(0f, 0f, 0f);
        }
