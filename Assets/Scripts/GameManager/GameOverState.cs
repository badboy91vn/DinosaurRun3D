...
public class GameOverState : AState
{
    ...
    private string inputName = "Player Name";

    public override void Enter(AState from)
    {
        canvas.gameObject.SetActive(true);

        miniLeaderboard.playerEntry.inputName.text = inputName;//PlayerData.instance.previousName;
	...
	protected void FinishRun()
    {
		...
		{
			miniLeaderboard.playerEntry.inputName.text = inputName;
		}
		else
		{
